...
*/
?>
<div class="tml tml-register my-login-form" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="registerform" id="registerform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url('register', 'login_post'); ?>" method="post">
		<div class="view-mode-1">
			<p>
				<label for="user_doctor_no<?php $template->the_instance(); ?>"><?php _e('醫師證號 *', 'theme-my-login') ?></label>
